...
export const data = new SlashCommandBuilder().setName('help').setDescription('通知設定とコマンドの使い方')
export async function execute(interaction: ChatInputCommandInteraction) {
    await interaction.reply({ ephemeral: true, embeds: [new EmbedBuilder().setTitle('地震・津波・気象情報 Bot').setColor(0x3498db).setDescription(
